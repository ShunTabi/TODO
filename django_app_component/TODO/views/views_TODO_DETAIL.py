...
# 定義
sql_1 = "SELECT TODO_DETAIL_ID,GENRE_NAME,TODO_HEADER_NAME,TODO_DETAIL_NAME,PRIOR_SUBNAME,TODO_DETAIL_STARTDATE,TODO_DETAIL_ENDDATE FROM V_TODO_DETAIL WHERE PRIOR_ID != (SELECT PRIOR_ID FROM T_PRIOR WHERE PRIOR_SUBNAME = ? ) AND TODO_DETAIL_VISIBLESTATUS = ? ORDER BY TODO_DETAIL_ENDDATE,PRIOR_ID LIMIT ? OFFSET ?"
...
sql_2 = "SELECT TODO_DETAIL_ID,GENRE_NAME,TODO_HEADER_NAME,TODO_DETAIL_NAME,PRIOR_SUBNAME,TODO_DETAIL_STARTDATE,TODO_DETAIL_ENDDATE FROM V_TODO_DETAIL WHERE TODO_DETAIL_ID IN (SELECT TODO_DETAIL_ID FROM V_TODO_DETAIL WHERE PRIOR_ID = (SELECT PRIOR_ID FROM T_PRIOR WHERE PRIOR_SUBNAME = ? ) OR TODO_DETAIL_VISIBLESTATUS = ?) ORDER BY TODO_DETAIL_ENDDATE,PRIOR_ID LIMIT ? OFFSET ?"
