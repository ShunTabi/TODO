...
# 定義
<<<<<<< HEAD
sql_1 = "SELECT TODO_HEADER_ID,TODO_HEADER_NAME,GENRE_NAME, TODO_HEADER_DATE,TODO_HEADER_VISIBLESTATUS FROM V_TODO_HEADER WHERE TODO_HEADER_VISIBLESTATUS = ? ORDER BY TODO_HEADER_DATE LIMIT ? OFFSET ?"
sql_1_count = "SELECT COUNT(*) FROM V_TODO_HEADER WHERE TODO_HEADER_VISIBLESTATUS = ? ORDER BY TODO_HEADER_DATE"
sql_2 = "SELECT TODO_HEADER_ID, TODO_HEADER_NAME , GENRE_NAME, TODO_HEADER_DATE,TODO_HEADER_VISIBLESTATUS FROM V_TODO_HEADER WHERE TODO_HEADER_ID NOT IN (SELECT TODO_HEADER_ID FROM V_TODO_HEADER WHERE TODO_HEADER_VISIBLESTATUS = ?) ORDER BY TODO_HEADER_DATE LIMIT ? OFFSET ?"
=======
sql_1 = "SELECT TODO_HEADER_ID,GENRE_NAME,TODO_HEADER_NAME,TODO_HEADER_DATE,TODO_HEADER_VISIBLESTATUS FROM V_TODO_HEADER WHERE TODO_HEADER_VISIBLESTATUS = ? ORDER BY TODO_HEADER_DATE LIMIT ? OFFSET ?"
sql_1_count = "SELECT COUNT(*) FROM V_TODO_HEADER WHERE TODO_HEADER_VISIBLESTATUS = ? ORDER BY TODO_HEADER_DATE"
...
sql_3 = "SELECT TODO_HEADER_ID,TODO_HEADER_NAME,GENRE_NAME,TODO_HEADER_DATE,TODO_HEADER_VISIBLESTATUS FROM V_TODO_HEADER WHERE TODO_HEADER_ID = ?"
...
sql_6 = "INSERT INTO T_TODO_HEADER(TODO_HEADER_NAME,GENRE_ID,TODO_HEADER_DATE,TODO_HEADER_VISIBLESTATUS) VALUES(?,(SELECT GENRE_ID FROM T_GENRE WHERE GENRE_NAME = ?),?,?)"
sql_7 = "UPDATE T_TODO_HEADER SET TODO_HEADER_NAME = ?,GENRE_ID = (SELECT GENRE_ID FROM T_GENRE WHERE GENRE_NAME = ?),TODO_HEADER_DATE = ?,TODO_HEADER_VISIBLESTATUS = ? WHERE TODO_HEADER_ID = ?"
