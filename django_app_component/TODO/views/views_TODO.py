...
#定義
sql_1 = "SELECT TODO_ID,TODO_NAME,GENRE_NAME,PRIOR_SUBNAME,TODO_STARTDATE,TODO_ENDDATE FROM V_TODO WHERE GENRE_VISIBLESTATUS = ? AND PRIOR_VISIBLESTATUS = ? AND TODO_VISIBLESTATUS = ? ORDER BY TODO_ENDDATE"
sql_2 = "SELECT TODO_ID,TODO_NAME,GENRE_NAME,PRIOR_NAME,TODO_STARTDATE,TODO_ENDDATE FROM V_TODO WHERE TODO_ID = ?"
sql_3 = "SELECT GENRE_ID,GENRE_NAME FROM T_GENRE WHERE GENRE_VISIBLESTATUS = ?"
sql_4 = "SELECT PRIOR_ID,PRIOR_NAME FROM T_PRIOR WHERE PRIOR_VISIBLESTATUS = ?"
